...
export default function SelfAssesmentScreen4({ navigation }) {
  ...
  const handleNext = () => {
    ...
    if (rating !== null) {
      console.log("Q4 Rating selected:", rating);
        ...
        <View style={styles.innerContainer}>
          ...
          <View style={styles.ratingContainer}>
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 1 ? "#01796F" : "#002a00" },
              ]}
              onPress={() => setRating(1)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 2 ? "#01796F" : "#008000" },
              ]}
              onPress={() => setRating(2)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 3 ? "#01796F" : "#00d400" },
              ]}
              onPress={() => setRating(3)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 4 ? "#01796F" : "#2aff2a" },
              ]}
              onPress={() => setRating(4)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 5 ? "#01796F" : "#80ff80" },
              ]}
              onPress={() => setRating(5)}
            >
