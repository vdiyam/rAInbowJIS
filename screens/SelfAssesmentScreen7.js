...
export default function SelfAssesmentScreen7({ navigation }) {
  ...
  const handleNext = () => {
    ...
    if (rating !== null) {
      console.log("Q7 Rating selected:", rating);
        ...
        <View style={styles.innerContainer}>
          ...
          <View style={styles.ratingContainer}>
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 1 ? "purple" : "#3a1986" },
              ]}
              onPress={() => setRating(1)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 2 ? "purple" : "#5124bc" },
              ]}
              onPress={() => setRating(2)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 3 ? "purple" : "#7143db" },
              ]}
              onPress={() => setRating(3)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 4 ? "purple" : "#c2aff0" },
              ]}
              onPress={() => setRating(4)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 5 ? "purple" : "#ebe4fa" },
              ]}
              onPress={() => setRating(5)}
            >
            ...
            <TouchableOpacity
              style={[
                styles.button,
                { backgroundColor: rating === 6 ? "purple" : "gray" },
              ]}
              onPress={() => setRating(6)}
            >
